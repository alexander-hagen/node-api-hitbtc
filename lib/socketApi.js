...
const baseUrl = 'wss://api.hitbtc.com/api/2/ws/public';
...
var HitbtcSocket = function(url, keys) {
  ...
  this.socket = new SocketClient(async (url) => {
...
var socketApi = module.exports = function(keys) {
  return new HitbtcSocket(baseUrl, keys);
};

var tradingApi = module.exports = function(keys) {
  return new HitbtcSocket(tradingUrl, keys);
};

var accountApi = module.exports = function(keys) {
  return new HitbtcSocket(accountUrl, keys);
};
